    ...
    <div className="bg-[url('/profile_bg.jpg')] bg-cover min-h-screen">
      <div className="p-5 md:p-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[32%_68%] bg-[#F8F5EC]">
          <div className="h-[500px] flex flex-col items-center justify-center p-8 gap-6 border-[#e6e6e6]">
          ...
          <div className="border-l-[2px] pb-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mx-5 mb-6">
              <div>
                <label
                  for="first_name"
                  className="block text-gray-700 text-sm font-medium mt-5 mb-2 uppercase"
                >
                  First Name
                </label>
                <input
            ...
            <button className="block text-sm text-center mx-auto sm:w-50 px-12 py-2 bg-stone-500 text-white font-semibold rounded-lg shadow-md hover:bg-stone-600 focus:outline-none focus:ring-2 focus:ring-stone-400 transition duration-300 ease-in-out;">
              Submit Change
            </button>
          </div>
        </div>
