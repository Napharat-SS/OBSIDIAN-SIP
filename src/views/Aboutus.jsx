...
const Aboutus = () => {
  return (
    <>
    <div
          className=" absolute bg-left bg-[length:1800px_1800px] text-white font-poppins "
    ...
    <div className="relative m-10 ">
            <div className="flex-col md:flex-row lg:flex ">
              ...
              <div className="flex-1">
                <div className="text-justify bg-black opacity-60 p-8 shadow-md rounded-2xl mt-5 ">
                  ...
                  แต่เป็นสถานที่ที่คุณจะได้สัมผัสกับบรรยากาศอบอุ่นเป็นกันเองพร้อมจิบกาแฟแก้วโปรดที่เราตั้งใจปรุงอย่างดีที่สด เพื่อให้ทุกแก้วของคุณ เต็มไปด้วยรสชาติที่ลงตัว และความสุขที่แท้จริงของการดื่มกาแฟ
                  </p>
                </div>
              </div>

              <div className="relative flex-col md:flex-row lg:flex mt-3 ml-3">
                <div className="w-90 ">
                  <Lens>
                    <img
                ...
                <div className="w-90 mt-3 md:-ml-10 md:mt-10 lg:-ml-10 xl:-ml-10 ">
                  <Lens>
                    <img className="border-4 rounded-2xl" src="./hot-caramelmacchiato.jpg" alt="macchiato" />
                  </Lens>
                </div>
            ...
            <div className=" flex-col md:flex-row md:-mt-4 lg:flex mt-3 mr-3">
             
                <iframe
                  className=" flex-1 rounded-2xl shadow-md mb-3 w-90"
