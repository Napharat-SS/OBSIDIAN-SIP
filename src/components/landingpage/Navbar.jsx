...
const Navbar = () => {
  ...
  return (
    ...
    `}
      ...
      {/* Drawer */}
      <div
        className={`fixed top-0 right-0 h-full bg-black shadow-lg z-50 transform transition-transform duration-300 
    ...
    w-full sm:w-80 md:w-96`}
      >
        ...
        <div className="p-4 overflow-y-auto h-full">
          ...
          <button className="w-full bg-[#c58c4ce6] text-black py-2 rounded-2xl hover:bg-[#ddb07ee6] transition-colors duration-300 text-sm font-medium focus:outline-none mt-4">
            Add to Basket
          </button>
        </div>
      </div>
          ...
          <div className="absolute -top-5 left-1/2 -translate-x-1/2">
            <Link
              ...
              className={`flex items-center justify-center rounded-full p-3 shadow-lg transition-transform ${
                routeIsActive("/")
                  ? "bg-[#c58c4ce6] text-black scale-110"
